 ...
 */
final class Version20251205185232 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'add token sub and created at to user';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE "user" ADD token_sub VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" DROP token_sub');
